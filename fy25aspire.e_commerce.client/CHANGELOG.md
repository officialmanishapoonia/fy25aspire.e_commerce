...
- Create Angular project with ng: `ng new fy25aspire.e_commerce.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fy25aspire.e_commerce.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `fy25aspire.e_commerce.client.esproj`).
